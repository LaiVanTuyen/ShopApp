...
public class MessageKeys {
    ...
    public static final String REFRESH_TOKEN_SUCCESSFULLY = "user.login.refresh_token_successfully";
//    public static final String REFRESH_TOKEN_FAILED = "user.login.refresh_token_failed";
